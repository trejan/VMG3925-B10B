...
CONFIG_QUALCOMM_SDK_VERSION:=spf-8.0
QSDK_PATH:=$(TOPDIR)/tmp/qsdk-$(CONFIG_QUALCOMM_SDK_VERSION)
qsdk_build:
	mkdir -p $(TOPDIR)/tools/opal_qsdk_pack/common/build/ipq
	cp $(TOPDIR)/bin/ipq/openwrt* $(TOPDIR)/tools/opal_qsdk_pack/common/build/ipq
	cd $(TOPDIR)/tools/opal_qsdk_pack/common/build && python zyxel_nand.py
	cp -a $(TOPDIR)/tools/opal_qsdk_pack/common/build/bin/nand* $(TOPDIR)/bin

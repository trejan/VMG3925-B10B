...
ifneq ($(CONFIG_IGNORE_OPENWRT_GEN_FILES),)
kernel_files=$(foreach fdir,$(FILES_DIR),$(fdir)/.)
...
ifeq ($(CONFIG_IGNORE_OPENWRT_GEN_FILES),)
__need_update_gerenic_patch_dir=$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(GENERIC_PATCH_DIR),generic/)
endif
...
define Quilt/Refresh/Kernel
	...
	$(call __need_update_gerenic_patch_dir)

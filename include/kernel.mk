...
CUSTOM_KPATCH_PREFIX=$(call qstrip, $(CONFIG_CUSTOM_KPATCH_PREFIX))
...
ifeq ($(DUMP),1)
  ...
  ifeq ($(TARGET_BUILD),1)
    PATCH_DIR ?= $(if $(wildcard ./$(CUSTOM_KPATCH_PREFIX)patches-$(KERNEL_PATCHVER)),./$(CUSTOM_KPATCH_PREFIX)patches-$(KERNEL_PATCHVER),./patches)

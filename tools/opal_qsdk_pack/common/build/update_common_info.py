...
-------------------------------------------------------------------------------
  ...
  $Header: //depot/asic/ipq8066/IPQ8074.ILQ.7.0/meta/main/latest/common/build/update_common_info.py#21 $
  $DateTime: 2017/11/27 12:37:02 $
...
if FIT_tool:
  ...
  #exported_tools += mi.get_tool_path('exported_tools')
   ...
   lg.log("update_common_info: Executing prepareSingleImage.py and pack command for 64 bit")
   ...
   ret_pack_32image = lg.log_exec(['python', pack_tool,  '--arch', "ipq807x",'--fltype', "nand,norplusnand,emmc,norplusemmc,nor" , '--srcPath', ipq_dir, '--inImage', ipq_dir ,'--outImage', bin_dir ],verbose=0)

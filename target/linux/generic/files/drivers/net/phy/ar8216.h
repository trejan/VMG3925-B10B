...
#define   AR8327_PAD_SGMII_DELAY_EN		BIT(19) // should be remove? need to modify mach-ap135.c
#define   AR8327_PAD_SGMII_CLK_PHASE_SEL	BITS(18, 2)
#define   AR8327_PAD_SGMII_CLK_PHASE_SEL_S	18

...
enum ar8327_sgmii_clk_phase_sel {
	AR8327_SGMII_CLK_PHASE_SEL0 = 0,
	AR8327_SGMII_CLK_PHASE_SEL1,
	AR8327_SGMII_CLK_PHASE_SEL2,
	AR8327_SGMII_CLK_PHASE_SEL3,
};
...
struct ar8327_pad_cfg {
	...
	bool txclk_delay_en;
	bool rxclk_delay_en;
	bool sgmii_delay_en; // should be remove? need to modify mach-ap135.c

...
ifeq ($(wildcard $(LINUX_DIR)/drivers/net/ppp),)
PPP_DIR=/drivers/net
else
PPP_DIR=/drivers/net/ppp
endif

ifeq ($(wildcard $(LINUX_DIR)/drivers/net/slip),)
SLIP_DIR=/drivers/net
else
SLIP_DIR=/drivers/net/slip
endif
...
define KernelPackage/ppp
  ...
  KCONFIG:= \
	...
	CONFIG_SLHC
  FILES:= \
	$(LINUX_DIR)$(PPP_DIR)/ppp_async.ko \
	$(LINUX_DIR)$(PPP_DIR)/ppp_generic.ko \
	$(LINUX_DIR)$(SLIP_DIR)/slhc.ko
...
define KernelPackage/ppp-synctty
  ...
  FILES:=$(LINUX_DIR)$(PPP_DIR)/ppp_synctty.ko
...
define KernelPackage/pppox
  ...
  FILES:=$(LINUX_DIR)$(PPP_DIR)/pppox.ko
...
define KernelPackage/pppoe
  ...
  KCONFIG:=CONFIG_PPPOE
  FILES:=$(LINUX_DIR)$(PPP_DIR)/pppoe.ko
...
define KernelPackage/pptp
  ...
  KCONFIG:=CONFIG_PPTP
  FILES:=$(LINUX_DIR)$(PPP_DIR)/pptp.ko
...
define KernelPackage/mppe
  ...
  KCONFIG:= \
	...
	CONFIG_PPP_MPPE
  FILES:=$(LINUX_DIR)$(PPP_DIR)/ppp_mppe.ko

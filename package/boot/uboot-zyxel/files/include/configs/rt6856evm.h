...
#define CONFIG_BOARD_RT6856EVM  1
#define ZLOADER_EXEC_FAILED_LED_INDICATE \
do { \
        configure_pio(31, ZGPIO_CONFIG_OUTPUT); \
        configure_pio(21, ZGPIO_CONFIG_OUTPUT); \
        set_pio(31, ZGPIO_LEVEL_HIGH);	/* Power LED off */ \
...
#define CONFIG_SYS_PROMPT           "RT6856# "		/* Monitor Command Prompt    */
...
#define CFG_LOADER_PART_ADDR		0
  ...
  #define CFG_ROOTFS_PART_SIZE		0x5B0000
...
#define CONFIG_ICPLUS_GPHY			1
#define CONFIG_ICPLUS_GPHY_ID0		0x0243
#define CONFIG_ICPLUS_GPHY_ID1		0x0D90
#define CONFIG_ICPLUS_GPHY_ADDR		MAC_TO_GIGAPHY_MODE_ADDR
#if 0
#define CONFIG_MARVELL_GPHY			1
#define CONFIG_MARVELL_GPHY_ID0		0x0141
#define CONFIG_MARVELL_GPHY_ID1		0x0CC2
#define CONFIG_MARVELL_GPHY_ADDR	MAC_TO_GIGAPHY_MODE_ADDR
#define CONFIG_VTSS_GPHY			1
#define CONFIG_VTSS_GPHY_ID0		0x0007
#define CONFIG_VTSS_GPHY_ID1		0x0421
#define CONFIG_VTSS_GPHY_ADDR		MAC_TO_GIGAPHY_MODE_ADDR
#endif

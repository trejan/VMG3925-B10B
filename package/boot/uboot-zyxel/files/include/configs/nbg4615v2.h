...
do { \
        ...
        configure_pio(0, ZGPIO_CONFIG_OUTPUT); \
        set_pio(28, ZGPIO_LEVEL_HIGH);  /* Power LED off */ \
        set_pio(0, ZGPIO_LEVEL_LOW);    /* WPS LED on */ \
} while(0)
 ...
 * Board Configuration
 */
#define CONFIG_BOARD_NBG4615v2  1
#define CONFIG_BOARD_NAME       "NBG4615v2"
